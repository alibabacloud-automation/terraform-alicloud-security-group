...
//  count             = local.group_id != "" ? length(var.ingress_rules) : 0
//  type              = "ingress"
...
//  count             = local.group_id != "" ? length(var.ingress_with_cidr_block) : 0
//  type              = "ingress"
...
//  count                    = local.group_id != "" ? length(var.ingress_with_source_security_group_id) : 0
//  type                     = "ingress"
...
//  count             = local.group_id != "" ? length(var.ingress_ports) : 0
//  type              = "ingress"
...
//  count             = local.group_id != "" ? length(var.ingress_cidr_blocks) : 0
//  type              = "ingress"
//  ip_protocol       = var.default_protocol
//  nic_type          = "intranet"
//  port_range        = "${var.ingress_port_with_cidrs}/${var.ingress_port_with_cidrs}"
//  security_group_id = local.group_id
//  cidr_ip           = var.ingress_cidr_blocks[count.index]
//  priority          = var.priority
//  description       = "An Security group rule came from terraform-alicloud-modules/security-group"
//}
//
//resource "alicloud_security_group_rule" "egress_rules" {
//  count             = local.group_id != "" ? length(var.egress_rules) : 0
//  type              = "egress"
...
//  count             = local.group_id != "" ? length(var.egress_with_cidr_block) : 0
//  type              = "egress"
...
//  count                    = local.group_id != "" ? length(var.egress_with_source_security_group_id) : 0
//  type                     = "egress"
...
//  count             = local.group_id != "" ? length(var.egress_ports) : 0
//  type              = "egress"
//  ip_protocol       = var.default_protocol
//  nic_type          = "intranet"
...
//  count             = local.group_id != "" ? length(var.egress_cidrs) : 0
//  type              = "egress"
//  ip_protocol       = var.default_protocol
//  nic_type          = "intranet"
